...
http.global.agent.maxSockets = 10000;
http.global.maxKeepAliveTime = 0; //close immediately when we finish a request
https.global.agent.maxSockets = 10000; 
https.global.maxKeepAliveTime = 0; //close immediately when we finish a request
